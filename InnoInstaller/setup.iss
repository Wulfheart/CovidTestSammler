...
AppId={{1064C934-0785-4DCF-872D-999ECF95B300}
AppName={#MyAppName}
AppVersion={#MyAppVersion}
;AppVerName={#MyAppName} {#MyAppVersion}
AppPublisher={#MyAppPublisher}
DefaultDirName={autopf}\CovidTestOutlookCollector
...
[Files]
Source: "C:\Users\Alex\source\repos\CovidTestSammler\CovidTestOutlookCollector\bin\Release\net5.0-windows\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
